...
from optim_factory import create_optimizer, KAConvNetLayerDecayValueAssigner
from datasets import build_dataset
from engine import train_one_epoch, evaluate
from utils import NativeScalerWithGradNormCount as NativeScaler
import utils

from KAConvNet import *
from ConvNet import *
...
def get_args_parser():
    ...
    parser.add_argument("--block_nums", type=list, default=[1, 1, 3, 1], help="block nums in stages")
...
def main(args):
    ...
    #   ================================================== build model ================================ #
    model = KAConvNet(args.in_channels, args.nb_classes, args.channels, args.block_nums, args.drop_path)
    # model = ConvNet(args.in_channels, args.nb_classes, args.channels, args.block_nums, args.drop_path)
    #   ================================================== build model ================================ #
    ...
    if args.layer_decay < 1.0 or args.layer_decay > 1.0:
        ...
        assigner = KAConvNetLayerDecayValueAssigner(
