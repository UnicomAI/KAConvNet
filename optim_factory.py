...
def get_num_layer_for_ConvKANNet(var_name):
    """
    Divide [2, 2, 6, 2] layers into 12 groups; each group is 2 RepLK BLocks + 2 ConvFFN
...
class KAConvNetLayerDecayValueAssigner(object):
    ...
    def get_layer_id(self, var_name):
        return get_num_layer_for_ConvKANNet(var_name)
